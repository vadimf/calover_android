...
import com.varteq.catslovers.utils.qb.VerboseQbChatConnectionListener;
...
import com.varteq.catslovers.view.qb.adapter.AttachmentPreviewAdapter;
import com.varteq.catslovers.view.qb.adapter.ChatAdapter;
import com.varteq.catslovers.view.qb.dialog.ProgressDialogFragment;
import com.varteq.catslovers.view.qb.widget.AttachmentPreviewAdapterView;
...
public class ChatActivity extends BaseActivity implements OnImagePickedListener {
    ...
    public static void startForResult(Activity activity, Fragment fragment, int code, QBChatDialog dialogId) {
