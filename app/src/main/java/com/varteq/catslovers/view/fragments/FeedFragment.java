...
public class FeedFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        // video
        feedList.add(new Feed(5, new Date(), MediaViewerActivity.MEDIA_TYPE_VIDEO,
        ...
        // photo
        feedList.add(new Feed(5, new Date(), MediaViewerActivity.MEDIA_TYPE_PHOTO,
        ...
        // no media
        feedList.add(new Feed(5, new Date(), MediaViewerActivity.MEDIA_TYPE_NO_MEDIA,
