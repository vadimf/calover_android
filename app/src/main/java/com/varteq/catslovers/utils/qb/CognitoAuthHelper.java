...
public class CognitoAuthHelper {
    ...
    private static CognitoAuthHelper appHelper;
     ...
     */
    private static final String userPoolId = "eu-central-1_stXwzm1xQ";//"eu-west-1_WbvfR8oaj";//"us-east-2_PJrh4MavS";//"us-east-2_JejZaetXf";

    /**
     * Add you app id
     */
    private static final String clientId = "3df22ki4pl7vuakper8gq2mdrd";//"456jc34hsbmms5r0hv8jq8lsjp";//"5rg38ojmj4qp4lkhr2vmbmc8c2";//"6un4gdbg4mobf852k8ioqb3q1";
     ...
     */
    private static final String clientSecret = "1omckp41jqsudu3715jpi2r2kf4g88l719310uc30btsflfuuaem";//"";//
    ...
    public static void init(Context context) {
        ...
        if (appHelper == null) {
            appHelper = new CognitoAuthHelper();
        }

        if (userPool == null) {

            // Create a user pool with default ClientConfiguration
            userPool = new CognitoUserPool(context, userPoolId, clientId, null, cognitoRegion);
